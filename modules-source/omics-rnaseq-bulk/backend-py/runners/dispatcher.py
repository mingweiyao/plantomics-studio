...
# 模块根目录(env、scripts 等)
MODULE_ROOT = Path("/opt/plantomics-studio/modules/omics-rnaseq-bulk")
...
PY_RUNNERS = {
    ...
    JobKind.STAR_INDEX.value: "star_index_runner",
    JobKind.STAR_ALIGN.value: "star_align_runner",
    JobKind.FEATURE_COUNTS.value: "feature_counts_runner",
    JobKind.NORMALIZE.value: "normalize_runner",
    JobKind.DATA_VOLUME_STATS.value: "data_volume_stats_runner",
    JobKind.ALIGN_STATS.value: "align_stats_runner",
    JobKind.LIBRARY_QC.value: "qualimap_runner",
    JobKind.NEW_TRANSCRIPTS.value: "stringtie_runner",
    JobKind.TRANSDECODER.value: "transdecoder_runner",
    JobKind.ALT_SPLICING.value: "rmats_runner",
    JobKind.LNCRNA.value: "lncrna_runner",
    JobKind.MERGE_COUNTS.value: "merge_counts_runner",
    # 一键运行(Python 编排器)
    JobKind.PIPELINE_UPSTREAM.value: "pipeline_upstream_runner",
}
