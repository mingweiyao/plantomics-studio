...
# 模块根目录(env、scripts 等)
MODULE_ROOT = Path("/opt/plantomics-studio/modules/omics-drs")
...
PY_RUNNERS = {
    ...
    JobKind.FLAIR.value: "flair_runner",
    ...
    JobKind.LNCRNA_PREDICT.value: "lncrna_predict_runner",
    JobKind.POLYA.value: "polya_runner",
    JobKind.POLYA_ANALYSIS.value: "polya_analysis_runner",
    JobKind.RNA_MOD.value: "rna_mod_runner",
}
