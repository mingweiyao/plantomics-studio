...
class JobKind(str, Enum):
    BASECALL = "basecall"              # Dorado basecalling (pod5->fastq)
    NANOFILT = "nanofilt"              # NanoFilt QC (q>=10, len>=50)
    POLYA_DETECT = "polya_detect"      # poly(A) proportion detection
    RRNA_REMOVE = "rrna_remove"        # rRNA removal
    MINIMAP2_ALIGN = "minimap2_align"  # minimap2 alignment
    PINFISH = "pinfish"                # Pinfish consensus transcript
    STRINGTIE = "stringtie"            # StringTie merge
    GFFCOMPARE = "gffcompare"          # gffcompare novel transcript
    TRANSDECODER = "transdecoder"      # TransDecoder CDS
    ANNOT_7DB = "annot_7db"            # 7 DB annotation
    LNCRNA_IDENTIFY = "lncrna_identify" # lncRNA identification (CPC2+PLEK)
    SALMON_QUANT = "salmon_quant"      # Salmon quantification
    SUPPA2 = "suppa2"                  # SUPPA2 alternative splicing
    FUSION = "fusion"                  # Fusion detection
    POLYA_ANALYSIS = "polya_analysis"  # poly(A) length analysis
