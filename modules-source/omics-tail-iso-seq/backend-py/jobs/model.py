...
class JobKind(str, Enum):
    NANOFILT = "nanofilt"                    # NanoFilt QC (q>=7)
    PYCHOPPER = "pychopper"                  # Pychopper full-length identification
    MINIMAP2_ALIGN = "minimap2_align"        # minimap2 alignment
    PINFISH = "pinfish"                      # Pinfish consensus transcript
    STRINGTIE = "stringtie"                  # StringTie redundancy removal
    ...
    LNCRNA_PREDICT = "lncrna_predict"        # lncRNA prediction (CNCI+CPC2+PLEK)
    POLYA = "polya"                          # poly(A) detection
    POLYA_ANALYSIS = "polya_analysis"        # poly(A) analysis
